...
const patchEsm = () => {
    ...
    if ( !(index.CSS && index.CSS.supports && index.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-a684dd52.js'); }).then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !index.win.customElements) {
            ...
            // @ts-ignore
            return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-dom" */ './dom-43451bac.js'); }).then(() => opts);
        }
    }
